...
namespace ioservice.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult WorkingTransportResources()
        {
...
"},300000);");
        ...
        public ActionResult WorkingAttackChecker()
        {
            return JavaScript(
        ...
        public ActionResult WorkingGetAllColonies()
        {
            string colonies =
        ...
        public ActionResult WorkingCastleAttackChecker()
        {
            return JavaScript(
        ...
        public ActionResult WorkingGetResources()
        {
            return JavaScript(
                "var count = {" +
                "nmbr: Number(1)};" +
        ...
        public ActionResult WorkingResearchesReduceBy10Min()
        {
            return JavaScript(
        ...
        public ActionResult WorkingBuildingsReduceBy10Min()
        {
            return JavaScript(
